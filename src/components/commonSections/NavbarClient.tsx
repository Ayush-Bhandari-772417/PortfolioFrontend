...
//       {/* Mobile drawer */}
//       {isOpen && (
//         <div className="fixed top-0 left-0 w-full h-screen bg-white flex flex-col items-center justify-center gap-6 text-xl">
//           <Link href="/projects" onClick={() => setIsOpen(false)}>Projects</Link>
//           <Link href="/creations" onClick={() => setIsOpen(false)}>Creations</Link>
//           <button onClick={() => setModalOpen(true)}>Hire Me</button>
//         </div>
//       )}
